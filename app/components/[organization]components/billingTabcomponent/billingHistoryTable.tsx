...
const columns: readonly Column[] = [
  { id: "InvoiceDate", label: "Invoice Date", minWidth: 220 },
  { id: "Invoice#", label: "Invoice #", minWidth: 120 },
  { id: "Amount", label: "Amount", minWidth: 140 },
  { id: "Period", label: "Period", minWidth: 140 },
            ...
            <TableRow>
              ...
              >
                <Box display="flex" justifyContent="space-between">
                  ...
                  >
                    <Image src={plusIcon} alt="plus icon" className="mr-1" />
                    Add Invoice Record
                  </Button>
                </Box>
              </TableCell>
