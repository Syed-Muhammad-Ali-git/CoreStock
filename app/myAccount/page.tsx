...
const MyAccountPage = () => {
    ...
    const handleUpdateProfile = (e?: React.FormEvent) => {
        ...
        setErrors({});
        console.log("Profile updated:", { fullName: values.fullName, email: values.email, image });
    };
    ...
    const handleChangePassword = (e?: React.FormEvent) => {
        ...
        setValues((s) => ({ ...s, oldPassword: "", newPassword: "", confirmPassword: "" }));
    };
                ...
                <Stack spacing="md">
                    ...
                    <SimpleGrid cols={3} breakpoints={[{ maxWidth: "768px", cols: 1 }]} spacing="md">
                        <PasswordInput
                            ...
                            onChange={(e) => setValues((s) => ({ ...s, oldPassword: e.target.value }))}
